      ...
      >
        <div className="container-base">
          <div className="flex flex-col gap-2">
            <div className="hidden lg:flex items-center justify-end gap-4 text-xs text-slate-600">
              <a href="tel:+97142545150" className="inline-flex items-center gap-2 transition hover:text-slate-900">
                <Phone className="h-3.5 w-3.5 text-gold-500" />
                Landline: +971 4 254 5150
              </a>
              <span className="h-4 w-px bg-slate-200" aria-hidden />
              <a href="tel:+971554701475" className="inline-flex items-center gap-2 transition hover:text-slate-900">
                <Phone className="h-3.5 w-3.5 text-gold-500" />
                Mobile: +971 55 470 1475
              </a>
              <span className="h-4 w-px bg-slate-200" aria-hidden />
              <a href="mailto:info@alamalmortgage.com" className="inline-flex items-center gap-2 transition hover:text-slate-900">
                <Mail className="h-3.5 w-3.5 text-gold-500" />
                info@alamalmortgage.com
              </a>
              <span className="h-4 w-px bg-slate-200" aria-hidden />
              <a href="https://www.alamalmortgage.com" className="inline-flex items-center gap-2 transition hover:text-slate-900">
                www.alamalmortgage.com
              </a>
            </div>
            ...
            <div className="flex h-20 items-center gap-8">
              ...
              <div className="hidden flex-1 items-center justify-end gap-6 lg:flex">
                ...
                <div className="flex items-center gap-2 border-l border-slate-200 pl-4 whitespace-nowrap">
                  <motion.div whileHover={shouldReduceMotion ? undefined : ctaPulse.hover} initial="rest" animate="rest">
                    <Link href="/eligibility-checker" className={cn(buttonVariants({ variant: "outline", size: "sm" }), "h-10 leading-none")}>
                      Get Pre-Qualified
                    </Link>
                  </motion.div>
                  <motion.div whileHover={shouldReduceMotion ? undefined : ctaPulse.hover} initial="rest" animate="rest">
                    <Link href="/contact" className={cn(buttonVariants({ variant: "primary", size: "sm" }), "h-10 leading-none")}>
                      Book Consultation
                    </Link>
                  </motion.div>
                </div>
              ...
              <motion.div whileTap={shouldReduceMotion ? undefined : { scale: 0.96 }}>
                <Button variant="ghost" size="sm" className="lg:hidden" onClick={() => setOpen((prev) => !prev)} aria-label="Toggle navigation" aria-expanded={open} aria-controls="mobile-nav">
